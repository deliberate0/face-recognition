...
class NetworkBuilder:
    ...
    def attach_pooling_layer(self, input_layer, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1],
                             padding="SAME"):
    ...
    def attach_sigmod_layer(self, input_layer):
        with tf.name_scope("Activation") as scope:
            return tf.nn.sigmoid(input_layer)

    def attach_soft_max_layer(self, input_layer):
        with tf.name_scope("Activation") as scope:
